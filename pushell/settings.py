"""
Django settings for pushell project.
...
config.read(os.path.join(BASE_DIR, 'pushell.conf'))
...
#ROOT_URLCONF = 'pushell.urls'
ROOT_URLCONF = 'pushell.urls'

WSGI_APPLICATION = 'pushell.wsgi.application'
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'pushell.context_processors.name_proc',
)
